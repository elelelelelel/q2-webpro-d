...
namespace MVCMenus.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public ActionResult Details(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                menumodel = r.Menus.FirstOrDefault(x => x.BooksId == code);
            }
        ...
        public ActionResult Edit_Get(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                menumodel = r.Menus.Where(x => x.BooksId == code).FirstOrDefault();
            }
        ...
        public ActionResult Edit_Post(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                var m = r.Menus.Where(x => x.BooksId == code).FirstOrDefault();
                TryUpdateModel(m);
                r.SaveChanges();
            }
        ...
        public ActionResult Delete_Post(string code)
        {
            ...
            using (var r = new MenusEntities())
            {
                var m = r.Menus.Remove(r.Menus.FirstOrDefault(x => x.BooksId == code));
                TryUpdateModel(m);
                r.SaveChanges();
            }
